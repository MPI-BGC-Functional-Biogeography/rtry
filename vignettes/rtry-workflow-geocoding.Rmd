...
input_locations <- rtry_import("input/data_locations.csv", separator = ",", encoding = "UTF-8", quote = "\"")
...
```R
## input: input/data_locations.csv
## dim:   20 3
...
## File saved at: output/locations_to_coordinates.csv
```
...
```R
input_coordinates <- rtry_import("input/data_coordinates.csv", separator = ",", encoding = "UTF-8", quote = "\"")
```

```R
## input: input/data_coordinates.csv
## dim:   20 2
