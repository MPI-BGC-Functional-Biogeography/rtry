...
![rtry_explore_usecase_2](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_explore_usecase_2.png)
...
![rtry_explore_usecase_3](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_explore_usecase_3.png)
...
![rtry_select_col_usecase_2](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_select_col_usecase_2.png)
...
![rtry_select_row_usecase_2](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_select_row_usecase_2.png)
...
To remove outliers, or say to select all interested auxiliary data and only the trait data with with ErrorRisk < 4:
...
![rtry_select_row_usecase_3](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_select_row_usecase_3.png)
...
```R
rtry_filter(input = "", ..., showOverview = TRUE)
```
...
![rtry_filter_usercase_1_01](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_filter_usercase_1_01.png)
...
![rtry_filter_usercase_1_02](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_filter_usercase_1_02.png)
...
![rtry_filter_usercase_1_03](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_filter_usercase_1_03.png)
...
![rtry_filter_usercase_1_04](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_filter_usercase_1_04.png)
...
This function excludes data from the input data based on the specified criteria and the corresponding ```ObsDataID```.



```R
rtry_exclude(input = "", ..., showOverview = TRUE)
```
...
| ```showOverview``` | Default ```TRUE``` displays the dimension of data table after excluding |



**Use case 1**

To exclude the data with incorrect units:

```R
tmp <- rtry_exclude(TRYdata, (TraitID == 3116  & UnitName != "mm2 mg-1") |
                               (TraitID == 144  & UnitName != "mm") |
                               (TraitID == 3107  & UnitName != "m") |
                               (TraitID == 21  & UnitName != "m") |
                               (TraitID == 4  & UnitName != "g/cm3"), showOverview = FALSE)
```
...
![rtry_geocoding_usecase_2_01](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_geocoding_usecase_2_01.png)
...
![rtry_geocoding_usecase_2_02](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_geocoding_usecase_2_02.png)
...
![rtry_revgeocoding_usecase_2_01](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_revgeocoding_usecase_2_01.png)
...
![rtry_revgeocoding_usecase_2_02](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_revgeocoding_usecase_2_02.png)
...
![rtry_revgeocoding_usecase_2_03](C:\Users\hlam\ownCloud\TRY_R\rtry\doc\image\rtry_revgeocoding_usecase_2_03.png)
