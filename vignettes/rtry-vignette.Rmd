...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{rtry-vignette}
...
Since the `rtry` package is developed and built with R 4.0.2, it is also the minimum version of R required to use the package. It is also recommended to use the latest version of RStudio when using the package.
