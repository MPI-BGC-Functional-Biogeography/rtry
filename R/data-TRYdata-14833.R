#' Sample TRY data (Request 14833)
#'
#' A dataset requested from the [TRY Database](https://www.try-db.org/TryWeb/Prop0.php).
#' The request ID of this dataset is 14833, which contains \code{TraitID}: 3115, 3116, 3117
#' and \code{AccSpeciesID}: 10773, 35846, 45737.
#'
#' @format A data frame with 6409 rows and 28 variables:
#' \describe{
...
#'   \item{OriginalName}{Original name of sub-trait or context information}
...
#'   \item{StdUnit}{Standard unit: available for standardized traits}
...
#'   \item{Comment}{Explanation for the \code{OriginalName} in the contributed dataset}
